...
#ifndef Collision_HelperFXParams_H
#define Collision_HelperFXParams_H
...
static const AkPluginParamID PARAM_BANDQ = 1;              
static const AkPluginParamID PARAM_BANDFREQ = 2;
static const AkPluginParamID PARAM_SATPARAM = 3;
static const AkUInt32 NUM_PARAMS = 4;

struct Collision_HelperRTPCParams
{
    AkReal32 fPlaceholder;
    AkReal32 Bandpass_Q;
    AkReal32 Bandpass_Cutoff;
    AkReal32 Sat_Param;
};

struct Collision_HelperNonRTPCParams
{
};

struct Collision_HelperFXParams
    : public AK::IAkPluginParam
{
    Collision_HelperFXParams();
    Collision_HelperFXParams(const Collision_HelperFXParams& in_rParams);
    ...
    Collision_HelperRTPCParams RTPC;
    Collision_HelperNonRTPCParams NonRTPC;
};

#endif // Collision_HelperFXParams_H
