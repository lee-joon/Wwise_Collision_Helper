...
#ifndef Collision_HelperFX_H
#define Collision_HelperFX_H

#include "Collision_HelperFXParams.h"
#include "Utils.h"
#include "Filters.h"

const AkReal32 APPROX_VALUE = 0.0001f;
...
private:
    Collision_HelperFXParams* m_pParams;
