...
local Plugin = {}
Plugin.name = "Collision_Helper"
Plugin.factoryheader = "../SoundEnginePlugin/Collision_HelperFXFactory.h"
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
Plugin.authoring = {}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "Collision_Helper.def",
    "Collision_Helper.xml",
    "**.rc",
}
