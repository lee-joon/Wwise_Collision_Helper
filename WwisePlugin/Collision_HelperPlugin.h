...
class Collision_HelperPlugin final
    : public AK::Wwise::Plugin::AudioPlugin
{
public:
    Collision_HelperPlugin();
    ~Collision_HelperPlugin();
...
DECLARE_AUDIOPLUGIN_CONTAINER(Collision_Helper);	// Exposes our PluginContainer structure that contains the info for our plugin
