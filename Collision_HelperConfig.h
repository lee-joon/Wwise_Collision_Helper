...
#ifndef Collision_HelperConfig_H
#define Collision_HelperConfig_H
...
namespace Collision_HelperConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 11977;
}

#endif // Collision_HelperConfig_H
